...
public class CheckController {
    ...
    public Check getCheckInfo(@RequestBody Check check){
        ...
        String leaveType = "";
        //"事假";
        check1.setLeaveDays1(checkService.getLeaveDayNumber(check,"2"));
        //"婚假";
        check1.setLeaveDays2(checkService.getLeaveDayNumber(check,"3"));
        //"丧假";
        check1.setLeaveDays3(checkService.getLeaveDayNumber(check,"1"));
        //"产假";
        check1.setLeaveDays4(checkService.getLeaveDayNumber(check,"6"));
        //"陪产假";
        check1.setLeaveDays5(checkService.getLeaveDayNumber(check,"7"));
        //"病假";
        check1.setLeaveDays6(checkService.getLeaveDayNumber(check,"5"));
        //"年假";
        check1.setLeaveDays7(checkService.getLeaveDayNumber(check,"4"));
        return check1;
    }
